...
void KeyStone_SRIO_CSR_CAR_Config(SRIO_Config * srio_cfg)
{
    ...
    gpSRIO_regs->RIO_PE_FEAT	= 
		...
		|(1 << CSL_SRIO_RIO_PE_FEAT_MEM_SHIFT) 	/*PE is not a memory*/
    ...
    gpSRIO_regs->RIO_SRC_OP     = 
		(1 << CSL_SRIO_RIO_SRC_OP_G_READ_SHIFT) 	//???
		|(1 << CSL_SRIO_RIO_SRC_OP_G_IREAD_SHIFT) 	//???
		|(1 << CSL_SRIO_RIO_SRC_OP_G_READ_OWN_SHIFT)//???
		|(0 << CSL_SRIO_RIO_SRC_OP_G_DC_INVALIDATE_SHIFT)	//???
		|(0 << CSL_SRIO_RIO_SRC_OP_G_CASTOUT_SHIFT) 		//???
		|(0 << CSL_SRIO_RIO_SRC_OP_G_DC_FLUSH_SHIFT) 		//???
		|(1 << CSL_SRIO_RIO_SRC_OP_G_IO_READ_SHIFT) 		//???
		...
		|(1 << CSL_SRIO_RIO_SRC_OP_ACSWAP_SHIFT) 	//???
		...
		|(1 << CSL_SRIO_RIO_SRC_OP_A_SWAP_SHIFT) 	//???
    ...
    gpSRIO_regs->RIO_DEST_OP    = 
		(1 << CSL_SRIO_RIO_DEST_OP_G_READ_SHIFT)       	  //???
		|(1 << CSL_SRIO_RIO_DEST_OP_G_IREAD_SHIFT)          //???
		|(1 << CSL_SRIO_RIO_DEST_OP_G_READ_OWN_SHIFT)       //???
		|(0 << CSL_SRIO_RIO_DEST_OP_G_DC_INVALIDATE_SHIFT)  //???
		|(0 << CSL_SRIO_RIO_DEST_OP_G_CASTOUT_SHIFT)        //???
		|(1 << CSL_SRIO_RIO_DEST_OP_G_DC_FLUSH_SHIFT)       //???
		|(1 << CSL_SRIO_RIO_DEST_OP_G_IO_READ_SHIFT)        //???
    ...
    gpSRIO_regs->RIO_SP_GEN_CTL 		=  // agent, master, undiscovered
		(1 << CSL_SRIO_RIO_SP_GEN_CTL_HOST_SHIFT)
...
void KeyStone_SRIO_Init(SRIO_Config * srio_cfg)
{
	...
	return_sta = KeyStone_enable_PSC_module(CSL_PSC_PD_SRIO, CSL_PSC_LPSC_SRIO);
	...
	KeyStone_SRIO_Timeout_Config(srio_cfg, 500000, 50000, 100);
